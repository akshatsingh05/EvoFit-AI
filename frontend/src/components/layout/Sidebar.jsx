...
import { LayoutDashboard, Dumbbell, Salad, TrendingUp, ClipboardCheck, User, Settings as SettingsIcon, UploadCloud } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/import-plan', label: 'Import Plan', icon: UploadCloud },
